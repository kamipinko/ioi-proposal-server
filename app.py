...
def confirm_booking():
    ...
    gmail = get_gmail_service()
    meet_text = meet_link or 'A meeting link will be sent shortly.'

    internal_subject = f"[Booking] {contact_name} — {agency_name} — {date} {time_str}"
    internal_body = (
    ...
    prospect_subject = f"Your Call with Proles Home Healthcare Consultants — {date} at {time_str}"
    prospect_body = (
        f"Hi {contact_name},\n\n"
        f"Your 15-minute call is confirmed!\n\n"
